package com.facci.appvotanteslfrj;
...
public class MainActivityLFRJ extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_lfrj);
    ...
    public void InsetarBtn (View v) {
        ...
        if (Insertadatos) {
            Toast.makeText(MainActivityLFRJ.this, "Datos Ingresados", Toast.LENGTH_SHORT).show();
        }else{Toast.makeText(MainActivityLFRJ.this,"Datos no Ingresados ocurrio un error",Toast.LENGTH_SHORT).show();}
    }
    ...
    public void Modificar (View v) {
        ...
        if(ActualizandoDatos)
            ...
            Toast.makeText(MainActivityLFRJ.this,"Lo sentimos ocurrió un error",Toast.LENGTH_SHORT).show();
    ...
    public void Eliminar (View v) {
        ...
        if(registrosEliminados > 0 ){
            Toast.makeText(MainActivityLFRJ.this,"Registro(s) Eliminado(s)",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(MainActivityLFRJ.this,"ERROR: Registro no eliminado",Toast.LENGTH_SHORT).show();
        }
    }
